...
"")
        ...
        self.CScreen_L.setStyleSheet("color: white;")
        ...
        self.sideBar.setGeometry(QtCore.QRect(0, 0, 200, 604))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/Icons/Icons/increasing.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.sales_sdbtn.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/Icons/Icons/transaction-history.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.transaction_sdbtn.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/Icons/Icons/inventory.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.inventory_sdbtn.setIcon(icon4)
        ...
        self.records_sdbtn.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/Icons/Icons/report.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.reports_sdbtn.setIcon(icon6)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/Icons/Icons/optimizing.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.maintenance_sdbtn.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/Icons/Icons/about.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.about_sdbtn.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/Icons/Icons/logout.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.log_out_sdbtn.setIcon(icon10)
