...
"}")
        ...
        self.ItemsNo = QtWidgets.QLabel(self.widget_16)
        self.ItemsNo.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.ItemsNo.setObjectName("ItemsNo")
        self.horizontalLayout_8.addWidget(self.ItemsNo)
