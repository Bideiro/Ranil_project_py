...
class DLG_Edit_User(QDialog, Ui_Dialog):
    ...
    def __init__(self, Ulist = None,parent = None):
        ...
        self.MName_LE.setText(self.currlist[7])
        self.Suffix_CB.setCurrentIndex(int(self.currlist[8]))
        self.ULevel_CB.setCurrentIndex(int(self.currlist[1]))
        self.Email_LE.setText(self.currlist[11])
        self.BDate_DE.setDate(self.currlist[14])
        self.Sex_CB.setCurrentIndex(int(self.currlist[9]))
        self.Phono_LE.setText('+' + self.currlist[10])
        self.Pos_LE.setText(self.currlist[12])
        self.DHired_DE.setDate(self.currlist[13])
        self.Address_LE.setText(self.currlist[15])
