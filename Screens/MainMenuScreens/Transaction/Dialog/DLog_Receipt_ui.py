...
"}")
        ...
        self.label_2.setText("#6, Rizal Avenue, Balite, Montalban (Rodriguez) Rizal")
        ...
        self.PMethod_L = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("Inconsolata")
        font.setPointSize(10)
        self.PMethod_L.setFont(font)
        self.PMethod_L.setObjectName("PMethod_L")
        self.verticalLayout_5.addWidget(self.PMethod_L)
        self.APaid_L = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("Inconsolata")
        font.setPointSize(10)
        self.APaid_L.setFont(font)
        self.APaid_L.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.APaid_L.setObjectName("APaid_L")
        self.verticalLayout_5.addWidget(self.APaid_L)
        ...
        self.GCRef_L = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("Inconsolata")
        font.setPointSize(10)
        self.GCRef_L.setFont(font)
        self.GCRef_L.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.GCRef_L.setObjectName("GCRef_L")
        self.verticalLayout_5.addWidget(self.GCRef_L)
...
"}")
        ...
        self.Print_btn.setMinimumSize(QtCore.QSize(0, 35))
        font = QtGui.QFont()
