...
"}")
        ...
        self.TotalPrice = QtWidgets.QLabel(self.widget_6)
        ...
        self.RID = QtWidgets.QLabel(self.widget_8)
        font = QtGui.QFont()
        font.setFamily("DM Sans")
        self.RID.setFont(font)
        self.RID.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.RID.setObjectName("RID")
        self.horizontalLayout_6.addWidget(self.RID)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.TotalPrice.setText(_translate("Dialog", "TextLabel"))
        ...
        self.RID.setText(_translate("Dialog", "TextLabel"))
