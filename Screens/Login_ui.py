...
"")
        ...
        self.userLE = QtWidgets.QLineEdit(self.widget_8)
        ...
        self.userLE.setMinimumSize(QtCore.QSize(350, 35))
        ...
        self.passwordLE = QtWidgets.QLineEdit(self.widget_8)
        ...
        self.passwordLE.setMinimumSize(QtCore.QSize(350, 35))
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.passwordLE)
        self.SPass_RB = QtWidgets.QRadioButton(self.widget_8)
        self.SPass_RB.setObjectName("SPass_RB")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.SPass_RB)
        ...
        spacerItem6 = QtWidgets.QSpacerItem(200, 20, QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.SPass_RB.setText(_translate("MainWindow", "Show Passcode"))
